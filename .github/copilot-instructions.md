# Copilot Instructions for graph

## Project Description

graph is a typed Python package that provides graph structures and algorithms for routing and path analysis workflows.
...
- This is a Python package with sources under `src/graph`.
